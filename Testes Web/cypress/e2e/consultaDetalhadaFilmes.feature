...
Cenário: Visualizando filme com usuário comum
    Dado que acesso filme como usuário comum
    Quando visualizo a pagina do filme
    Então consigo ver os detalhes do filme
...
Cenário: Visualizando filme com usuário crítico
    Dado que acesso filme como usuário crítico
    Quando visualizo a pagina do filme
    Então consigo ver os detalhes do filme  
...
Cenário: Visualizando filme com usuário admin
    Dado que acesso filme como usuário admin
    Quando visualizo a pagina do filme
    Então consigo ver os detalhes do filme
...
@review @deleteMovie
Cenário: Review de usuário deve permanecer a mesma após promoção para crítico
    Dado que acesso filme como usuário crítico
    Quando visualizo as avaliações
    Então minha avaliação feita como usuário comum permanece tipo comum

@review @deleteMovie
Cenário: Review de usuário deve permanecer a mesma após promoção para admin
    Dado que acesso filme como usuário admin
    Quando visualizo as avaliações
    Então minha avaliação feita como usuário comum permanece tipo comum