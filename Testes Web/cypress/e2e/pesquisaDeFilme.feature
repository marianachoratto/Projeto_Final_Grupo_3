...
Esquema do Cenário: Deve ser possível encontrar filme informando o título em letras maiúsculas ou minúsculas
    Quando informar o título '<título>' na barra de busca
    E clicar no botão de pesquisa
    Então visualizarei o filme correspondente na tela
    Exemplos:
    | título |
