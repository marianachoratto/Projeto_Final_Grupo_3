...
# É possivel ver a lista de filmes sendo usuario comum 
# Caso existam mais de seis filmes cadastrados deve ser possivel passar a lista para o lado e voltar
